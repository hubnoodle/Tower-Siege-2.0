...
function setup() {
  ...
  ground3 = new Ground(900,300,200,10);
  ...
  b2 = new Box(900,215,30,40);
  b3 = new Box(870,215,30,40);
  b4 = new Box(930,215,30,40);
  b5 = new Box(900,255,30,40);
  b6 = new Box(870,255,30,40);
  b7 = new Box(840,255,30,40);
  b8 = new Box(930,255,30,40);
  b9 = new Box(960,255,30,40);
